...
bool draw = false;
bool about_state=false;
const char *title = "Final Project 69";
...
{
    // Load sound
    song = al_load_sample("./sound/SuperMarioBros.mp3");
...
int process_event()
{
    ...
    /*if(about_state==true&&event.keyboard.keycode==ALLEGRO_KEY_BACKSPACE)
    {
